...
from settings import PROJECT_PATH, NOISE_BOUNDS, PAGES, PID_ANALYZER_PATH, BLACKBOX_DECODER_PATH
...
async def upload_bbl(request):
    ...
    asyncio.ensure_future(_analysis(job_id, bbl_content, noise_bounds))
...
async def _analysis(job_id, bbl_content, noise_bounds):
